...
public class RegistroUsuarioActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener{
    ...
    private void UIBind(){
        ...
        lista.add("Masculino");
        lista.add("Femenino");
//        spSexo.setOnItemClickListener(this);
    ...
    public void registrarUsuario(){
        ...
        if (TextUtils.isEmpty(etNombres.getText())){
            ...
            Toast.makeText(this, "El documento de identidad debe tener 8 caracteres", Toast.LENGTH_SHORT).show();
            return;
            ...
            Toast.makeText(this, "Contraseña no valida, debe tener como minimo 4 caracteres", Toast.LENGTH_SHORT).show();
            return;
        } else if (!Constantes.General.Validacion.isValidPassword(etContraseniaConfirm.getText().toString())) {
            Toast.makeText(this, "Contraseña de confirmacion no valida, debe tener como minimo 4 caracteres", Toast.LENGTH_SHORT).show();
            return;
